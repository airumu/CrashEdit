...
namespace CrashEdit
{
    public sealed class OldModelEntryController : EntryController
    {
        ...
        {
            return new DarkLabel { Text = string.Format("Polygon count: {0}", BitConv.FromInt32(OldModelEntry.Info, 0)), TextAlign = ContentAlignment.MiddleCenter, Font = new System.Drawing.Font("Microsoft Sans Serif", 9F) };
        }
